...
# 在现有界面右边增加一片区域，显示红黑方是AI还是人类玩家，显示当前是红方还是黑方走子
player_info_area = pygame.Surface((200, 400))
player_info_area.fill((255, 255, 255))
screen.blit(player_info_area, (600, 0))

# 显示红黑方是AI还是人类玩家
font = pygame.font.Font(None, 36)
red_player_type = "AI" if player1.agent == "AI" else "Human"
black_player_type = "AI" if player2.agent == "AI" else "Human"
red_player_text = font.render("Red Player: " + red_player_type, True, (0, 0, 0))
black_player_text = font.render("Black Player: " + black_player_type, True, (0, 0, 0))
screen.blit(red_player_text, (610, 50))
screen.blit(black_player_text, (610, 100))

# 显示当前是红方还是黑方走子
current_player_color = board.get_current_player_color()
current_player_text = font.render("Current Player: " + current_player_color, True, (0, 0, 0))
screen.blit(current_player_text, (610, 200))
...
while True:
    ...
    if end:
        if winner != -1:
            ...
            print("Game end. Tie")
        sys.exit()# 加载两个玩家，AI对AI，或者AI对human
